...
<h2>application/controllers/api/<?php echo $_POST['view'] ?>.php</h2>
<div style="border: #555 solid 2px; height: 400px; overflow:auto; padding:10px;">
	<?php 
...
<div style="border: #555 solid 2px; height: 390px; overflow:auto; padding:10px;">
	<?php 
